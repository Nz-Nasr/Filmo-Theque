...
<main class="max-w-screen-lg mx-auto px-4 py-8">
    ...
    <h1 class="text-2xl font-bold mb-10">همه انیمیشن‌ها</h1>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        <?php if (have_posts()) : ?>
            <?php while (have_posts()) : the_post(); ?>
                ...
                <?php
                $poster = get_post_meta(get_the_ID(), 'poster_image_animation', true);
                $poster_url = $poster ? wp_get_attachment_url($poster) : get_template_directory_uri() . '/assets/images/animations/default.jpg';
                ?>
